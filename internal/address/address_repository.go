...
func (r *addressRepository) GetAllAddressesByUser(userID uint, addressType *string, isDefault *bool, sortBy, sortOrder string) ([]AddressEntity, error) {
	...
	if err != nil {
		l.Error("❌ Failed to fetch addresses", "method", "GetAllAddressesByUser", "error", err, "userID", userID, "addressType", addressType, "isDefault", isDefault, "sortBy", sortBy, "sortOrder", sortOrder)
	}
...
func (r *addressRepository) GetAllAddressesPaginated(showDeleted *bool, userID *uint, page, pageSize int, addressType *string, isDefault *bool, sortBy, sortOrder string) ([]AddressEntity, int64, error) {
	...
	if err := query.Count(&total).Error; err != nil {
		l.Error("❌ Failed to count addresses", "method", "GetAllAddressesPaginatedByUser", "error", err, "userID", userID, "page", page, "pageSize", pageSize, "addressType", addressType, "isDefault", isDefault, "sortBy", sortBy, "sortOrder", sortOrder)
		return nil, 0, err
	}

	err := query.Offset(utils.GetOffset(page, pageSize)).Limit(pageSize).Find(&addresses).Error
	if err != nil {
		l.Error("❌ Failed to fetch addresses paginated", "method", "GetAllAddressesPaginatedByUser", "error", err, "userID", userID, "page", page, "pageSize", pageSize, "addressType", addressType, "isDefault", isDefault, "sortBy", sortBy, "sortOrder", sortOrder)
	}
...
func (r *addressRepository) GetAddressByID(id uint, userID *uint, showDeleted *bool) (*AddressEntity, error) {
	...
	if err := query.First(&address).Error; err != nil {
		l.Error("❌ Failed to fetch address by ID", "method", "GetAddressByID", "error", err, "id", id, "userID", userID)
		return nil, err
	}
...
func (r *addressRepository) CreateAddress(address *AddressEntity) error {
	...
	if err != nil {
		l.Error("❌ Failed to create address", "method", "CreateAddress", "error", err, "address", address)
	}
	return err
}
...
func (r *addressRepository) UpdateAddress(address *AddressEntity) error {
	...
	if err != nil {
		l.Error("❌ Failed to update address", "method", "UpdateAddress", "error", err, "address", address)
	}
	return err
}
...
func (r *addressRepository) DeleteAddress(id uint) error {
	...
	if err != nil {
		l.Error("❌ Failed to delete address", "method", "DeleteAddress", "error", err, "id", id)
	}
	return err
}
...
func (r *addressRepository) RemoveAddress(id uint, userID uint) error {
	...
	if err != nil {
		l.Error("❌ Failed to remove address", "method", "RemoveAddress", "error", err, "id", id, "userID", userID)
	}
	return err
}
...
func (r *addressRepository) UndoDeleteAddress(id uint) error {
	...
	if err != nil {
		l.Error("❌ Failed to undo delete address", "method", "UndoDeleteAddress", "error", err, "id", id)
	}
	return err
}
...
func (r *addressRepository) SetDefaultAddress(id uint, userID uint, addressType string) error {
	...
	if err != nil {
		l.Error("❌ Failed to delete address", "method", "DeleteAddress", "error", err, "id", id, "userID", userID)
	}
	return err
}
...
func (r *addressRepository) AddressExists(id uint, userID *uint, showDeleted *bool) (bool, error) {
	...
	if err != nil || address.ID == 0 {
		l.Error("❌ Failed to check if address exists", "method", "AddressExists", "error", err, "id", id, "userID", userID)
		return false, err
	}
...
func (r *addressRepository) GetDefaultAddress(userID uint, addressType string) (*AddressEntity, error) {
	...
	if err != nil {
		l.Error("❌ Failed to get default address", "method", "GetDefaultAddress", "error", err, "userID", userID, "addressType", addressType)
		return nil, err
	}
