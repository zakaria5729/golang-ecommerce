...
func (h *CategoryHandler) GetAllCategories(w http.ResponseWriter, r *http.Request) {
	...
	categoryResponses, err := h.useCase.GetAllCategories(includeStr, parentIDFilter, showPriorityFilter, sortBy, sortOrder)
	if err != nil {
...
func (h *CategoryHandler) GetCategoryByID(w http.ResponseWriter, r *http.Request) {
	...
	categoryResponse, err := h.useCase.GetCategoryByID(*id, include)
	if err != nil {
...
func (h *CategoryHandler) ToggleCategoryStatus(w http.ResponseWriter, r *http.Request) {
	...
	categoryResponse, err := h.useCase.ToggleCategoryStatus(*id)
	if err != nil {
		response.SendErrorJSON(w, err.Error(), http.StatusInternalServerError)
		return
	}
